...
to {
  ...
  animation: ${q} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,K=({toast:t})=>{let{icon:e,type:r,iconTheme:s}=t;return void 0!==e?"string"==typeof e?i.createElement(z,null,e):e:"blank"===r?null:i.createElement(A,null,i.createElement(j,{...s}),"loading"!==r&&i.createElement(L,null,"error"===r?i.createElement(F,{...s}):i.createElement(_,{...s})))},N=b("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
