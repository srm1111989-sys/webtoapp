...
to {
  ...
  animation: ${q} 0.3s 0.12s cubic-bezier(0.175, 0.885, 0.32, 1.275)
    forwards;
`,K=({toast:t})=>{let{icon:e,type:r,iconTheme:s}=t;return void 0!==e?"string"==typeof e?i.createElement(z,null,e):e:"blank"===r?null:i.createElement(L,null,i.createElement(P,{...s}),"loading"!==r&&i.createElement(A,null,"error"===r?i.createElement(j,{...s}):i.createElement($,{...s})))},N=b("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
