...
export const competitors: Competitor[] = [
  ...
  },
  {
    ...
    pricing: {
      label: '$16–$60/year',
      detail:
        'WebIntoApp charges $16–$60/year, but push notifications, no-watermark, and key features are locked behind higher-tier annual plans.',
      annualCost: '$60+/year',
    },
    pros: [
      'Affordable entry price',
      'Simple drag-and-drop interface',
      'Android and basic iOS builds',
    ],
    cons: [
    ...
    features: [
      ...
      { name: 'Pricing model', them: '$16–$60/year', us: '$10 one-time', usBetter: true },
      { name: 'Subscription needed?', them: 'Yes — annual', us: 'No — pay once', usBetter: true },
    ...
    switchReasons: [
      ...
      'Windows desktop app (WebIntoApp has no desktop option)',
      'No watermark on every plan — not just premium',
      'More features in one $10 plan than WebIntoApp\'s most expensive tier',
    ],
