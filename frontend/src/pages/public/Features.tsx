    ...
    <div>
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y">
                  ...
                  <tr className="bg-primary-50">
                    ...
                    <td className="px-6 py-4 text-center"><span className="font-bold text-primary-600">$45</span></td>
          ...
          <div className="mt-12 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-8 text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <div className="bg-white rounded-xl p-4 border border-green-200">
                <div className="text-primary-600 font-bold text-3xl">$45</div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-primary-600 to-primary-800 text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-primary-100 text-lg mb-8">Get all 40+ features for just $45. No subscriptions, no hidden fees.</p>
