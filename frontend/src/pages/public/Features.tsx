    ...
    <div>
      ...
      <section className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm sm:text-base">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg px-6 py-3">
              <div className="font-bold text-2xl">₹999</div>
      ...
      <section className="py-16 sm:py-24 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
              ...
              <table className="w-full">
                ...
                <tbody className="divide-y">
                  ...
                  <tr className="bg-primary-50">
                    ...
                    <td className="px-6 py-4 text-center"><span className="font-bold text-primary-600">₹999</span></td>
                    <td className="px-6 py-4 text-center text-gray-600">₹2,999/year</td>
                    <td className="px-6 py-4 text-center text-gray-600">₹4,999/year</td>
                    <td className="px-6 py-4 text-center text-gray-600">₹1,999</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div className="mt-12 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200 rounded-2xl p-8 text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-3">You Save ₹12,500+ Over 5 Years</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto">
              <div className="bg-white rounded-xl p-4 border border-green-200">
                <div className="text-primary-600 font-bold text-3xl">₹999</div>
              ...
              <div className="bg-white rounded-xl p-4 border border-gray-200 opacity-75">
                <div className="text-gray-600 font-bold text-3xl">₹14,995</div>
                <div className="text-gray-600 text-sm">Competitor A (5 Years)</div>
              </div>
              <div className="bg-white rounded-xl p-4 border border-gray-200 opacity-75">
                <div className="text-gray-600 font-bold text-3xl">₹24,995</div>
      ...
      <section className="py-16 sm:py-24 bg-gradient-to-br from-primary-600 to-primary-800 text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-primary-100 text-lg mb-8">Get all 40+ features for just ₹999. No subscriptions, no hidden fees.</p>
