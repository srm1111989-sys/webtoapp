...
const faqs = [
  ...
  { q: 'Is WebsiteToApp better than GoNative or WebIntoApp?', a: 'WebsiteToApp offers 40+ features at a one-time price from $45 - vs GoNative ($99/month) and WebIntoApp (free with watermark, or $89 one-time to remove branding). You get more features for less, with no recurring subscription.' },
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-6 items-center mb-8">
            ...
            <div>
              ...
              <p className="text-base sm:text-lg text-gray-600 mb-5 max-w-xl">
                No coding. No developers. Just your website. One-time payment from <strong>$45</strong> — Android APK/AAB or Windows installer with branding, push notifications, and Play Store signing support. No monthly platform fee.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto overflow-x-auto -mx-4 px-4 sm:mx-auto sm:px-0">
            <table className="w-full border-collapse min-w-[600px]">
              ...
              <tbody>
                {([
                  { feature: 'Starting Price', a: '$99/mo', b: 'Free (branded)', c: '$99/mo', us: '$45 once', bold: true },
                  { feature: 'Unbranding Cost', a: 'Included', b: '$89 once', c: 'Included', us: '$45 once', bold: true },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 sm:gap-8 mb-16">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-green-100 hover:border-green-300 transition-all">
              ...
              <p className="text-gray-600 mb-4">
                Pay once, own forever. Android: $45. Desktop: $45. No subscriptions.
      ...
      <section className="py-12 sm:py-20 bg-primary-600 text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <Link to={isLoggedIn ? '/apps/create' : '/register'} className="bg-white text-primary-700 px-8 py-3 rounded-lg font-semibold text-lg hover:bg-gray-100 inline-flex items-center gap-2">
            {isLoggedIn ? 'Create New App' : 'Convert My Website - From $45'} <ArrowRight className="w-5 h-5" />
          </Link>
        </div>
      </section>
    </div>
