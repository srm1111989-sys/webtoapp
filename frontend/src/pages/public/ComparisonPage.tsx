      ...
      <section className="bg-gradient-to-br from-primary-700 to-primary-900 text-white py-16">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-3xl mx-auto">
            {competitor.name} costs {competitor.pricing.label}. WebToApp gives you the same — and more — for a <strong className="text-white">one-time $10 payment</strong>. No subscriptions. No renewals.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Switch to WebToApp — $10 One-Time <ArrowRight className="w-5 h-5" />
            </Link>
            <Link
              to="/pricing"
        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="border-2 border-green-300 ring-2 ring-green-400 rounded-2xl p-6 bg-green-50 relative">
              ...
              <p className="text-3xl font-extrabold text-green-700 mb-1">$10 one-time</p>
      ...
      <section className="py-16 bg-primary-600 text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-primary-100 mb-8 text-lg">
            One-time $10 payment. 40+ features. No subscriptions. 7-day money-back guarantee.
          </p>
          <Link
            to="/register"
          ...
          >
            Get Started — $10 One-Time <ArrowRight className="w-5 h-5" />
          </Link>
