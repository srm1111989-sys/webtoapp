...
PLANS = [
    {
        "name": "Android Free",
        "slug": "android-free",
        "description": "5 free builds total across your websites, all features, watermark & 15-day trial",
        "price_inr": 0,
        "price_usd": 0,
        ...
        "platform": "android",
        "sort_order": 1,
        # Free builds carry ALL app features so users can fully test before paying;
        # the paywall is the watermark + 15-day trial + 5-build limit, NOT features.
        # priority_support stays paid-only (a support tier, not a build capability).
        "features": {
            "twa": True,
    ...
    },
    {
        ...
        "platform": "desktop",
        "sort_order": 4,
        # All features for testing; watermark + 15-day trial + 5-build limit are the paywall.
        "features": {
            "custom_icon": True,
            "custom_splash": True,
            "custom_colors": True,
