...
async def chat_endpoint(
    ...
    try:
        ...
        system_instruction = (
            ...
            "If a user explicitly asks whether they are talking to a human, do not claim to be human — say you're part of "
            "WebsiteToApp's support team and share support@websitetoapp.app if they'd like a person to follow up directly. "
