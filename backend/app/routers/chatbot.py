...
async def chat_endpoint(
    ...
    try:
        ...
        system_instruction = (
            ...
            "- Pricing (one-time; Pro Monthly subscription optional): Free (watermarked, 15-day trial, 2 builds), Android App $45, iOS App (Beta) $45, Desktop App $45, Play Store Listing add-on $15, Android App + Play Store bundle $50. Indian users pay INR equivalent. Both APK and AAB files are provided on ALL plans, including free.\n"
