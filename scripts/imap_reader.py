"""
IMAP inbox reader for support@websitetoapp.app (Zoho).
Standalone — no dependencies on webtoapp app/ package.
...
_env_path = os.path.normpath(os.path.join(_here, "..", "backend", ".env"))
_creds = {}
